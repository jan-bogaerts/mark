...
The outline component is a tree structure positioned to the left of the editor, representing the outline of the active project and updated when changes are made to the project data, with nodes corresponding to markdown headings and the ability to track and update selected items.
