...
- handleLogMsg: add the parameter value to the components state field `logMsgs`
- the renderer of the log window loops over all the entries in logMsgs and displays the text. Make certain that the text is in a div that can be scrolled when the content is larger than the visible area.
